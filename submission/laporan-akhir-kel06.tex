...
\begin{tabular}{p{0.45\textwidth}p{0.45\textwidth}}
\centering Participant's signature & \centering Witness / researcher's signature \tabularnewline[0.3cm]
\centering \includegraphics[width=3.5cm]{syahmi_signature.png} & \centering \tabularnewline[0.5cm]
...
\begin{tabular}{p{0.45\textwidth}p{0.45\textwidth}}
\centering Participant's signature & \centering Witness / researcher's signature \tabularnewline[0.3cm]
\centering \includegraphics[width=3.5cm]{matthew_signature.png} & \centering \tabularnewline[0.5cm]
