...
\begin{description}[leftmargin=5.5cm,labelwidth=5cm, font=\small]
    ...
    \item[Colab -- Demo (Gradio):] \url{https://colab.research.google.com/drive/1rhoLvdyzKTdK9sGd4dRjkglO-lo2bBHB}
...
\textbf{Status akses:} repositori bersifat publik; seluruh tautan Colab dapat dibuka tanpa login. Sudah diverifikasi terbuka per 25 Mei 2026.
...
\centering \includegraphics[width=3.5cm]{calvin_signature.png} & \centering \tabularnewline[0.5cm]
